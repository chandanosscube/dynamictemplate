...
if(isset($_REQUEST))
	...
	$str1 .="user name:: &nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='name'>";
	$obj=new MyModel();
...
if(isset($result[0]['textbox']))
{
	...
	{
	$str1 .="<p>" .$val[$i]."&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' value=".$val1[$i]." name='textbox[".$val[$i]."]'></p>";
	}
}
if(isset($result[0]['textarea']))
{
	...
	for($i=0;$i<count($val)-1;$i++)
	{
	$str1 .="<p>" .$val[$i]."&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows='4' cols='50' name='textarea[".$val[$i]."]'>".$result[0]['textareavalue']."</textarea></p>";
	}
}
...
$str1 .="</select>";
$str1 .="<br/><a href='#' onclick='addField1()'>ADD FIELD</a><br/><div id='div6'></div>";
}
