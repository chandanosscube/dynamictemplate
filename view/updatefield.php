...
if($_REQUEST ['field']=="textarea")
{
	...
	$strField .="<p>validation::REQUIRED:<input id='checkbox1' class='required' value='required' type='radio' name='textradio'/>
			NOT REQUIRED:<input id='checkbox1' class='required' value='notrequired' type='radio' name='textradio'/></p>";
	$strField .="</div>";
}elseif ($_REQUEST ['field']=="textbox")
{
	...
	$strField .="<p>Data Type::<select name='datatype[]'><option>Integer</option><option>char</option><option>date</option></select></p>";
	$strField .="<p>validation::REQUIRED:<input id='checkbox1' class='required' value='required' type='radio' name='textboxradio'/>
			NOT REQUIRED:<input id='checkbox1' class='required'  value='notrequired' type='radio' name='textboxradio'/></p>";
	$strField .="</div>";
}elseif($_REQUEST ['field']=="checkbox")
{
	...
	$strField .="<p>Data Type::<select name='datatype[]'><option>Integer</option><option>char</option><option>date</option></select></p>";
	$strField .="<p>validation::REQUIRED:<input id='checkbox1' class='required' value='required' type='radio' name='checkboxradio'/>
			NOT REQUIRED:<input id='checkbox1' class='required' value='notrequired' type='radio' name='checkboxradio'/></p>";
	...
	$strField .="<p>Data Type::<select name='datatype[]'><option>Integer</option><option>char</option><option>date</option></select></p>";
	$strField .="<p>validation::REQUIRED:<input id='checkbox1' class='required' value='reuqired' type='radio' name='comboboxradio'/>
			NOT REQUIRED:<input id='checkbox1' class='required' value='notrequired' type='radio' name='comboboxradio'/></p>";
